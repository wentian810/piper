...
class DiffusionConfig(PreTrainedConfig):
    ...
    predict_action_as_delta_state: bool = False
    delta_state_key: str = "observation.state"
    use_relative_state_conditioning: bool = True
    relative_state_reduce: str = "last_delta"
    ...
    def validate_features(self) -> None:
        ...
        # Check that all input images have the same shape only when a shared RGB encoder is used.
        # If each camera has its own encoder, different native resolutions are allowed.
